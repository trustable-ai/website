...
description = "Multi-cloud compatibility, integrated frontend and backend services, an extensible CLI, a low-code console and a full-code cloud IDE."
weight = 10
+++
...
![Bird's eye view of the Nuvolaris platform](_page_2_Figure_3.jpeg)
